...
# Define bounding box for zooming in
bbox <- st_bbox(snake_range_sf)
...
ggplot() +
  ...
  labs(
    title = "Sidewinder Rattlesnake Distribution",
    subtitle = "Focused on California, Arizona, Nevada, Utah, Baja California, and Mexico",
    fill = "Legend"
  ) +
  theme_minimal() +
  theme(
